...
const CACHE = CACHE_PREFIX + "pages-2";
const ASSETS = ["./", "index.html", "app.js", "manifest.webmanifest", "icon-192.svg", "icon-512.svg", "icon-192.png", "icon-512.png", "apple-touch-icon.png"];
