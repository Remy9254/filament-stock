...
const CACHE = CACHE_PREFIX + "pages-3";
const ASSETS = ["./", "index.html", "app.js", "sync.js", "manifest.webmanifest", "icon-192.svg", "icon-512.svg", "icon-192.png", "icon-512.png", "apple-touch-icon.png"];
