...
const CACHE = CACHE_PREFIX + "corrections-8";
const ASSETS = ["./", "index.html", "app.js", "sync.js", "account.js", "corrections.js", "mobile.css", "mobile.js", "manifest.webmanifest", "icon-192.svg", "icon-512.svg", "icon-192.png", "icon-512.png", "apple-touch-icon.png"];
